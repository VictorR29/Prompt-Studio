...
export const walkthroughSteps: WalkthroughStep[] = [
  {
    ...
    content: 'Este es el Extractor. Analiza imágenes para extraer características como el estilo, la pose o los colores.',
    view: 'generator',
    placement: 'bottom',
  },
  {
    targetSelector: '[data-tour-id="nav-structurer"]',
    title: 'Estructurador de Prompts',
    content: 'Convierte tus ideas o imágenes en prompts JSON modulares, perfectos para un control detallado.',
    view: 'structurer',
    placement: 'bottom',
  },
  {
    targetSelector: '[data-tour-id="nav-assembler"]',
    title: 'Ensamblador Maestro',
    content: 'Combina fragmentos de diferentes imágenes para crear un prompt maestro complejo y coherente.',
    view: 'assembler',
    placement: 'bottom',
  },
  {
    ...
    content: 'Todos tus prompts y fragmentos guardados viven aquí, listos para ser reutilizados en cualquier momento.',
    view: 'gallery',
    placement: 'bottom',
  },
  {
